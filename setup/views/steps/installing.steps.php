...
?>
<li class="list-group-item pending" data-progress-cleancache>
	<b class="split__title">Cleaning cache</b>
...
<li class="list-group-item pending" data-progress-postinstall>
